...
Tested up to: WordPress 5.8-trunk
Version: 3.2.7
...
* Compatibility with woocommmerce latest version
* Block widget style imporved.
* Breadcrumbs imporved.
* Header logo issue solved.
* .POT file updated

= 3.2.5 =
* Released: June 13, 2021
* Compatibility with woocommmerce latest version
* Included Wishsuite plugin for wishlist
* Included Ever Compare plugin for WooCommerce
* Included WPML( Multi-Language Tools )
